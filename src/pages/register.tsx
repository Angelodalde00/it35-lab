...
import background from '../images/gojo.jpg';
        ...
        <IonPage>
            <IonContent className='ion-padding'>
              ...
              />
                ...
                <IonInput label="Email" labelPlacement="stacked" fill="outline" type="email" placeholder="youremail" value={email} onIonChange={e => setEmail(e.detail.value!)} style={{ marginTop: '15px' }} />
                ...
                <IonButton onClick={handleOpenVerificationModal} expand="full" shape='round' style={{ marginTop: '15px' }}color='tertiary'>
                    Register
                </IonButton>
